...
Done: Refactored the code to use AgglomerativeClustering instead of Kmeans
"""
...
def _cluster_kmeans_base(corr_mat: pd.DataFrame, max_num_clusters: int = 10, repeat: int = 10) -> Union[
    ...
    for _ in range(repeat):
        for num_clusters in range(2, max_num_clusters + 1):
            kmeans_ = AgglomerativeClustering(n_clusters=num_clusters, affinity="precomputed", linkage='complete')
